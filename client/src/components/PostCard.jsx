...
export default function PostCard({ post }) {
	...
	return (
		<div className="overflow-hidden shadow-xl rounded-lg w-[350px] md:mb-0 lg:mb-0 mb-4  bg-gray-200 border border-gray-300">
			{/* Image Container */}
			...
			<div className=" p-3 flex !text-light-100 items-center whitespace-nowrap justify-between gap-2">
				...
				<Link to={`/post/${post.slug}`} >
					<Button className='text-sm !bg-gray-300 text-light-100 hover:underline border-gray-100 border-opacity-10 border'>Read article</Button>
				</Link>
			</div>
		</div>
	);
