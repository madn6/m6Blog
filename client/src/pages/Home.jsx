...
export default function Home() {
	...
	return (
		<div className=" h-full  px-2 md:px-6  w-full  mx-auto">
			<div className="flex  gap-6 lg:mt-0 md:mt-6 mt-6  mb-4   px-2  w-full  mx-auto">
				<div className="flex flex-col items-start justify-end lg:gap-4 md:gap-2 gap-1">
					...
					<p className=" w-full lg:text-xl md:text-xl text-lg">
						Welcome to <span className="text-green-500">Mathan&apos;s </span> space where ideas come
						to life! Dive into engaging tech tutorials, heartfelt personal reflections, and the
						latest trends designed to inspire and connect. Each post is crafted with care, aiming to
						spark curiosity and fuel meaningful conversations.
					</p>
				</div>
